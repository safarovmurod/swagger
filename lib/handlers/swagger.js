...
module.exports = (req, res) => {
  ...
  res.end(JSON.stringify({
    ...
    paths: {
      ...
      '/api/categories': {
        ...
        post: {
          ...
          responses: { '201': { description: 'Категория создана', 'x-en': { description: 'Category created' }, content: { 'application/json': { schema: { $ref: '#/components/schemas/Category' } } } }, ...badRequest }
        }
      },
      '/api/categories/{id}': {
        get: {
      ...
      '/api/subcategories': {
        ...
        post: {
          ...
          responses: { '201': { description: 'Подкатегория создана', 'x-en': { description: 'Subcategory created' }, content: { 'application/json': { schema: { $ref: '#/components/schemas/Subcategory' } } } }, ...badRequest, ...notFound }
        }
      },
      ...
      '/api/products': {
        ...
        post: {
          ...
          responses: { '201': { description: 'Товар создан', 'x-en': { description: 'Product created' }, content: { 'application/json': { schema: { $ref: '#/components/schemas/Product' } } } }, ...badRequest }
        }
      },
      '/api/products/{id}': {
        get: {
      ...
      '/api/products/{id}/reviews': {
        get: {
          ...
          responses: { ...ok('ReviewList', 'Отзывы товара', 'Product reviews'), ...notFound }
        },
        post: {
          ...
          responses: { '201': { description: 'Отзыв добавлен', 'x-en': { description: 'Review added' }, content: { 'application/json': { schema: { $ref: '#/components/schemas/Review' } } } }, ...badRequest, ...notFound }
        }
      },
      '/api/promotions': {
        get: {
        ...
        post: {
          ...
          responses: { '201': { description: 'Акция создана', 'x-en': { description: 'Promotion created' }, content: { 'application/json': { schema: { $ref: '#/components/schemas/Promotion' } } } }, ...badRequest }
        }
      },
      '/api/promotions/{id}': {
        get: {
      ...
      '/api/blog': {
        get: {
          ...
          parameters: [
            q('search', 'string', 'Поиск по заголовку и анонсу', 'Search by title and excerpt'),
        ...
        post: {
          ...
          requestBody: body('BlogInput', { title: 'Как выбрать первую кроватку', excerpt: 'Разбираем виды кроваток и на что смотреть при покупке', content: 'Полный текст статьи…', image: 'https://images.unsplash.com/photo-1505693416388-ac5ce068068c?w=600&q=80', date: '2026-08-31' }),
          responses: { '201': { description: 'Статья создана', 'x-en': { description: 'Post created' }, content: { 'application/json': { schema: { $ref: '#/components/schemas/BlogPost' } } } }, ...badRequest }
        }
      },
      '/api/blog/{id}': {
        get: {
          tags: ['Blog'], summary: 'Статья по id (+ следующая)', 'x-en': { summary: 'Post by id (+ next one)' },
          parameters: [pathParam('id', 'id статьи', 'Post id', 'integer')],
    ...
    components: {
      schemas: {
        Error: { type: 'object', properties: { message: { type: 'string', example: 'Товар 999 не найден' } } },
        Pagination: {
          type: 'object',
          properties: {
        ...
        BlogPost: {
          ...
          properties: {
            ...
            nextPost: { type: 'object', nullable: true, properties: { id: { type: 'integer' }, title: { type: 'string' } } }
          }
        },
        BlogInput: {
          type: 'object', required: ['title'],
        ...
        CategoryPage: {
          allOf: [{ $ref: '#/components/schemas/Pagination' },
            { type: 'object', properties: { items: { type: 'array', items: { $ref: '#/components/schemas/Category' } } } }]
        },
        CategoryDetail: {
          allOf: [{ $ref: '#/components/schemas/Category' },
            { type: 'object', properties: { products: { $ref: '#/components/schemas/ProductPage' } } }]
        ...
        SubcategoryPage: {
          allOf: [{ $ref: '#/components/schemas/Pagination' },
            { type: 'object', properties: { items: { type: 'array', items: { $ref: '#/components/schemas/Subcategory' } } } }]
        },
        SubcategoryDetail: {
          allOf: [{ $ref: '#/components/schemas/Subcategory' },
            { type: 'object', properties: { products: { $ref: '#/components/schemas/ProductPage' } } }]
        ...
        PromotionPage: {
          allOf: [{ $ref: '#/components/schemas/Pagination' },
            { type: 'object', properties: { items: { type: 'array', items: { $ref: '#/components/schemas/Promotion' } } } }]
        },
        BlogPage: {
          allOf: [{ $ref: '#/components/schemas/Pagination' },
            { type: 'object', properties: { items: { type: 'array', items: { $ref: '#/components/schemas/BlogPost' } } } }]
        }
      }
    }
  }));
