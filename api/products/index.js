const { products, categories, jsonRes, paginate, getBody, lightProduct, nextId } = require('../_helpers');
...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    if (body.price === undefined || body.price === null) return jsonRes(res, 400, { message: 'Поле price обязательно' });
